...
import rclpy
from managed_subsystem.segmentation import SegmentationNode
...
class TestSegmentationNode(EngelClassTestTemplate):
    def setup_method(self):
        super().setup_method(expected_comm_objects=comm_types, node_to_test=SegmentationNode)
